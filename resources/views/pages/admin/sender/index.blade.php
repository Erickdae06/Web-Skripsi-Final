                ...
                <div class="col-lg-12">
                    <div class="card card-header-actions mb-4 ">
                        ...
                        <div class="card-body bg-light">
                            ...
                            @endif
                            {{-- List Data --}}
                            <table class="table table-striped table-hover table-sm table-light" id="crudTable">
                                <thead>
                                    <tr>
                                        <th width="10">No.</th>
                                        <th>Nama</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content bg-light text-dark">
                <div class="modal-header">
                    <h5 class="modal-title text-light" id="createModal">Tambah Data Pengirim Surat</h5>
